...
and a slot length of 20 seconds, this currently takes exactly 12 hours). \emph{If} that
stronger side condition were acceptable, we could retain invariant
\eqref{no_dep_trans} (although invariant \eqref{txins_in_dom_utxo} may still be
violated); but it is probably too restrictive.
